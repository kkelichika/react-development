...
- `src/apps/reduxTodo/ReduxTodoApp.js` - a to-do app with state in Redux (connected add/list/filter).
- `src/apps/notes/NotesApp.js` - capstone Notes app combining Redux + Router + Context.
